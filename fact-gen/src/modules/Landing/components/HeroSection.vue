<template>
    <section class="relative bg-[#1E40AF] text-white overflow-hidden">
        ...
        <!-- HERO CONTENT -->
        <div
            class="container mx-auto px-6 lg:px-20 pt-24 pb-32 min-h-[70vh] grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            ...
            <div class="flex justify-center lg:justify-end mt-10 lg:mt-0">
                <img :src="heroIllustration" alt="Illustration facture"
        ...
        <div class="absolute bottom-0 left-0 w-full overflow-hidden leading-[0]">
            <svg class="relative block w-full h-28" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320"
