  ...
  <div class="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50">
    ...
    <div class="flex min-h-screen">
      ...
      <div class="flex flex-col flex-1 min-h-screen">
        ...
        <nav class="lg:hidden bg-white border-t border-slate-200 px-2 py-2 safe-area-bottom">
          <div class="flex justify-around max-w-md mx-auto">
            <router-link
              to="/real"
              class="flex flex-col items-center py-2 px-3 rounded-xl transition-all duration-200 min-w-0"
              :class="
                $route.name === 'Real'
            ...
            >
              ...
              <span class="text-xs font-medium truncate">Tableau</span>
            </router-link>
            ...
            >
              ...
              <span class="text-xs font-medium truncate">Factures</span>
            </router-link>
            ...
            >
              ...
              <span class="text-xs font-medium truncate">Clients</span>
            </router-link>
            ...
            >
              ...
              <span class="text-xs font-medium truncate">Réglages</span>
            </router-link>
          </div>
        </nav>
      </div>
...
export default {
  ...
  beforeUnmount() {
    // Nettoyer le style du body lors de la destruction du composant
    document.body.style.overflow = '';
  },
};
</script>
