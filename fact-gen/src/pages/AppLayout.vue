        ...
        <div class="flex items-center justify-between h-14 lg:h-16">
          ...
          <div class="hidden lg:flex items-center space-x-4">
            ...
            <div class="flex items-center space-x-3">
              <div
                class="w-8 h-8 bg-gradient-to-r from-blue-500 to-purple-500 rounded-full flex items-center justify-center cursor-pointer shadow-md"
                title="Mon Compte"
              >
              ...
              >
                <i class="material-symbols-outlined text-xl">logout</i>
              </button>
            </div>
          </div>
        </div>
      ...
      <transition name="slide-from-left">
        ...
        >
          ...
          <div class="p-4 border-t bg-slate-50">
            ...
            >
              <i class="material-symbols-outlined text-base mr-2">logout</i>
              Se déconnecter
            </button>
          </div>
        </nav>
...
const DesktopNavItem = {
  ...
  template: `
    ...
    >
      <i class="material-symbols-outlined text-lg">{{ icon }}</i>
      <span>{{ label }}</span>
    </router-link>
  `
};
...
const MobileNavItem = {
  ...
  template: `
    ...
    >
      <i class="material-symbols-outlined w-6 h-6 mr-4">{{ icon }}</i>
      {{ label }}
    </router-link>
  `
};
...
const navItems = [
  { path: "/real", label: "Tableau de bord", routeName: "Real", icon: "dashboard" },
  { path: "/facture", label: "Gestion des factures", routeName: "Facture", icon: "receipt_long" },
  { path: "/clientFact", label: "Gestion des clients", routeName: "Client", icon: "group" },
  { path: "/templates", label: "Templates", routeName: "Templates", icon: "grid_view" }, // Nouveau Lien
  { path: "/setting", label: "Paramètres", routeName: "setting", icon: "settings" },
];
