        ...
        <div class="block sm:hidden space-y-3">
            ...
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center space-x-2">
                    ...
                    <ChevronRightIcon class="w-5 h-5 text-gray-400 group-hover:text-blue-500 transition-colors" />
                </div>
            </div>
        ...
        <div class="hidden sm:block">
            <div class="flex items-center justify-between">
                <div class="flex items-center space-x-6 flex-1">
                    ...
                    <div class="flex items-center space-x-3">
                        <div
                            class="w-12 h-12 bg-gradient-to-br from-blue-500 to-indigo-600 rounded-xl flex items-center justify-center shadow-md group-hover:shadow-lg transition-shadow">
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <ChevronRightIcon class="w-6 h-6 text-gray-400 group-hover:text-blue-500 transition-colors" />
                </div>
            </div>
        </div>
    </li>
...
const StatusBadge = {
    ...
    <div class="inline-flex items-center space-x-1.5 px-2.5 py-1 rounded-full text-xs font-medium border"
      ...
      <component :is="getStatusConfig(status).icon" class="w-3 h-3" />
