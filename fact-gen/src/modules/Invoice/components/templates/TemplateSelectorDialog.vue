...
<template>
    <div v-if="isTemplateDialogOpen" class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50"
        ...
        <div class="bg-white rounded-xl shadow-2xl max-w-4xl max-h-[80vh] overflow-hidden w-full mx-4">
            ...
            <div class="flex justify-between items-center p-6 border-b border-gray-200">
                ...
                <button @click="closeTemplateDialog" class="text-gray-400 hover:text-gray-600 text-2xl font-bold">
                    ×
                </button>
            </div>
            ...
            <div class="p-6 overflow-y-auto max-h-[60vh]">
                <div class="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
                    <div v-for="template in getAllTemplates" :key="template.id"
                        ...
                        <div class="relative overflow-hidden">
                            <img :src="template.previewUrl" :alt="template.nom"
