      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between h-16">
          <div class="flex items-center space-x-4">
            ...
            <h1 class="text-xl font-semibold">{{ isEditing ? 'Modifier' : 'Nouvelle' }} facture</h1>
          </div>
        ...
        <div class="lg:col-span-3 space-y-6">
          ...
          <div class="bg-white rounded-lg border p-6">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <router-link to="/templates" class="flex items-center justify-between p-3 border rounded-lg hover:border-blue-500 hover:bg-blue-50 group">
                  <span class="text-sm group-hover:text-blue-600">{{ getTemplateName(selectedTemplate) }}</span>
              ...
              <div>
                ...
                <select v-model="statut" required class="w-full p-3 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
          ...
          <div class="bg-white rounded-lg border p-6">
            <div class="flex items-center justify-between mb-4">
              ...
              <button @click="ajouterProduit" class="flex items-center space-x-2 px-4 py-2 bg-green-600 text-white text-sm rounded-lg hover:bg-green-700">
