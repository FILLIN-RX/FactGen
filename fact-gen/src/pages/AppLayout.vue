<template>
  <div class="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50">
    ...
    <header
      class="sticky top-0 z-40  bg-white/80 w-full backdrop-blur-md border-b border-slate-200 shadow-sm"
    >
      <div class="px-4 w-full flex justify-between sm:px-6 lg:px-8">
        <div class="flex items-center w-full justify-between h-16 sm:h-20">
          <div class="lg">
            <h1
    ...
    <div class="flex min-h-screen">
      <!-- Desktop Sidebar -->
      <div class="hidden lg:flex lg:w-72 xl:w-64">
