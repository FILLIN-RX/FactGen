<template>
  <div class="lg:flex">
    ...
    <section
      class="p-6 space-x-5 bg-white mx-auto rounded-2xl shadow-lg space-y-10"
    >
      <div class="lg:grid grid-cols-2 flex justify-between">
        ...
        />
        <div class="">
          <div class="space-y-4 space-x-5">
            <div class="grid grid-cols-2 border rounded-2xl p-2">
              <label for="date_emission">Date</label>
              <input
                type="date"
                id="date_emission"
            ...
            <div class="grid grid-cols-2 border rounded-2xl p-2">
                 <label for="dae_echeance">Date D'echeance</label>
            <input
              type="date"
              id="date_echeance"
      ...
      <div>
        ...
        <textarea
          ...
          class="w-full border-2 border-orange-200 rounded-xl p-4 h-24 resize-none"
        ></textarea>
      </div>
