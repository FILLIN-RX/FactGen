    ...
    <div class="w-full max-w-5xl">
      <div class="lg:grid lg:grid-cols-2 lg:gap-12 items-center">
        <div class="p-4 hidden lg:block">
          <img src="/assets/undraw_personal-information_h7kf.svg" alt="Illustration de données sécurisées" class="w-full h-auto">
        </div>
          ...
          <div class="bg-white rounded-2xl shadow-xl border border-gray-100 p-6 sm:p-10">
            ...
            <form @submit.prevent="onSubmit" class="space-y-6">
              ...
              <div>
                ...
                <div class="relative">
                  ...
                  <button type="button" @click="showPassword = !showPassword"
                    ...
                    <span v-if="showPassword" class="material-symbols-outlined text-xl">
                      visibility_off
                    </span>
              ...
              <div class="flex items-center justify-between">
                ...
                <a href="#" class="text-sm font-medium text-blue-600 hover:text-blue-500">Mot de passe oublié ?</a>
              </div>
              ...
              <button type="submit"
                ...
                :disabled="loading">
                <span v-if="loading" class="material-symbols-outlined animate-spin -ml-1 mr-3 text-white text-xl">
                  autorenew
                </span>
            ...
            <div v-if="errorMessage" class="mt-6 p-4 bg-red-50 border border-red-200 rounded-lg animate-fade-in">
