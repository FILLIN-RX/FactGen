...
<section class="p-6  space-x-5 bg-white max-w-4xl mx-auto rounded-2xl shadow-lg space-y-10">
  <div class="entete flex justify-between"> 
             <input type="file" accept="image/*" placeholder="importer votre logo" @change="previewLogo" class="bg-black rounded-full h-20 flex item-center justify-center w-20 text-center text-white justify-center">
             <div class="bg-black"></div>
          </div>
          <div class="justify-start bg-blue-200 rounded-xl p-5 w-1/2 space-y-5">
            <input v-model="societer.nom" type="text" class="w-full bg-blue-100 rounded-xl border border-gray-300 py-3 px-4 focus:outline-none focus:ring-2 focus:ring-blue-400 text-center">
            <input v-model="societer.email" type="email" class="w-full bg-blue-100 rounded-xl border border-gray-300 py-3 px-4 focus:outline-none focus:ring-2 focus:ring-blue-400 text-center">
            <input v-model="societer.adresse" type="text" class="w-full bg-blue-100 rounded-xl border border-gray-300 py-3 px-4 focus:outline-none focus:ring-2 focus:ring-blue-400 text-center">
...
<div class="text-center">
  ...
  <div class="bg-white p-6 mt-6 rounded-xl shadow-lg  mx-auto font-sans">
    <h2 class="font-bold text-2xl mb-6 text-center text-gray-700">Aperçu de la facture</h2>
...
export default {
  data() {
    return {
      ...
      societer: new societer('Mon Entreprise', '123 Rue Exemple', 'contact@entreprise.com', '0123456789'),
    };
  },
  computed: {
    factureInstance() {
